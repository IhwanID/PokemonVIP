...
class PokemonDetailRouter: NSObject, PokemonDetailRoutingLogic, PokemonDetailDataPassing
{
  ...
  //func navigateToSomewhere(source: PokemonDetailViewController, destination: SomewhereViewController)
  //{
  ...
  //func passDataToSomewhere(source: PokemonDetailDataStore, destination: inout SomewhereDataStore)
  //{
